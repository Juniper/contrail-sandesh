...
#ifdef SANDESH
extern t_type* g_type_static_const_string;
extern t_type* g_type_sandesh_system;
extern t_type* g_type_sandesh_request;
extern t_type* g_type_sandesh_response;
extern t_type* g_type_sandesh_trace;
