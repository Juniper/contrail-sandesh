...
void generate_sandesh_async_creator_helper(ofstream &out, t_sandesh *tsandesh, std::string sender_func_name, std::string logger_func_name, bool use_sandesh);
...
void t_cpp_generator::generate_sandesh_direct_send(ofstream &out, t_sandesh *tsandesh) {
    ...
    // Generate sender
    generate_sandesh_async_creator_helper(out, tsandesh, "DirectSend", "DirectLog", true);
}


void t_cpp_generator::generate_sandesh_async_creator_helper(ofstream &out, t_sandesh *tsandesh, std::string sender_func_name, std::string logger_func_name, bool use_sandesh) {
    bool is_flow = ((t_base_type *)tsandesh->get_type())->is_sandesh_flow();
...
void t_cpp_generator::generate_sandesh_async_creators(ofstream &out, t_sandesh *tsandesh) {
    ...
    generate_sandesh_async_creator_helper(out, tsandesh, "Send", "Log", false);
