...
void t_cpp_generator::generate_sandesh_async_creators(ofstream &out, t_sandesh *tsandesh) {
    ...
    if (is_system) {
        ...
        out << indent() << "if (rate_limit_logged_) {" << endl;
        indent_up();
        out << indent() << "DropLog" <<
           generate_sandesh_async_creator(tsandesh, false, false, false, "",
                                          "", false, false) << "; " << endl;
        out << indent() << "rate_limit_logged_=false;" << endl;
        scope_down(out);
        out << indent() << "return;" << endl;
        scope_down(out);
        scope_down(out);
...
void t_cpp_generator::generate_sandesh_definition(ofstream& out,
    ...
    if (((t_base_type *)t)->is_sandesh_system()) {
        out << indent() << "static bool rate_limit_logged_;" << endl;
...
void t_cpp_generator::generate_sandesh_static_rate_limit_log_def(
                                           ofstream& out, t_sandesh* tsandesh) {
    out << "bool " << tsandesh->get_name() << "::rate_limit_logged_ = true;"
        << endl << endl;
}
...
void t_cpp_generator::generate_isRatelimitPass(ofstream& out,
    ...
    out << indent() << "if (rate_limit_buffer_.capacity()==rate_limit_buffer_.size()) {" << endl;
    ...
    out << indent() << "rate_limit_logged_ = true;" << endl;
