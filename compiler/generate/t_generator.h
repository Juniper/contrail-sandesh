...
#ifdef SANDESH
  virtual void generate_sandesh (t_sandesh*   tsandesh)  = 0;
  virtual void generate_sandesh_info () {}
#endif
...
#ifdef SANDESH
  /**
   * Method to get the sandesh name, may be overridden
   */
  virtual std::string get_sandesh_name(t_sandesh* tsandesh) {
    return tsandesh->get_name();
  }
#endif
...
#ifdef SANDESH
  /**
   * Quick accessor for formatted sandesh name that is currently being
   * generated.
   */
