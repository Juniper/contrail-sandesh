...
literal_begin (['\"])
format_str    (%([1-9]$)?([+-]?[ -#0])?([1-9]+)?(\.[1-9]+)?(hh|h|l|ll|L|z|j|t)?(d|u|f|F|e|E|g|G|x|X|o|s|c))
...
"systemlog"          { return tok_system;               }
"request"            { return tok_request;              }
"response"           { return tok_response;             }
...
"abcfunction"        { return tok_abcfunction;          }
