...
class SandeshBaseLogger(object):
    ...
    def is_local_logging_enabled(self):
        return self._logging_params.get('enable_local_log', False)
    ...
    def logging_file(self):
        return self._logging_params.get('file', '<stdout>')
 
    def is_syslog_logging_enabled(self):
        return self._logging_params.get('enable_syslog', False)

    def logging_syslog_facility(self):
        return self._logging_params.get('syslog_facility', 'LOG_LOCAL0')
