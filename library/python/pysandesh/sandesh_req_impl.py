...
class SandeshReqImpl(object):
    ...
    def sandesh_sending_params_set_handle_request(self, sandesh_req):
        ...
        if sandesh_req.throttling_rate is not None:
            SandeshSystem.set_sandesh_send_rate_limit(
                sandesh_req.throttling_rate)
        if sandesh_req.enable_system_and_object_logs is not None:
            self._sandesh.disable_sending_system_and_object_logs(
                not sandesh_req.enable_system_and_object_logs)
        ...
        sandesh_sending_resp = SandeshSendingParams(
            throttling_rate=SandeshSystem.get_sandesh_send_rate_limit(),
            enable_system_and_object_logs= \
                not self._sandesh.is_sending_system_and_object_logs_disabled(),
