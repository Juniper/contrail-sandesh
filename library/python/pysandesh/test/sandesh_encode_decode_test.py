...
class SandeshEncodeDecodeTest(unittest.TestCase):
    ...
    def test_basic_types(self):
        ...
        btype_encode = BasicTypesTest(bool_1=True, byte_1=127, i16_1=4321,
            ...
            ipaddr_1=ipaddress.IPv4Address('10.1.2.1'),
            ipaddr_2=ipaddress.IPv6Address('2001:1::2'))
    ...
    def test_container_types(self):
        ...
        list_ipaddr_1 = [ipaddress.ip_address('192.168.1.10'),
            ipaddress.ip_address('2001:0:3238::fefb')]
