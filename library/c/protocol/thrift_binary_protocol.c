...
int32_t
thrift_binary_protocol_write_uuid (ThriftProtocol *protocol, const uuid_t value,
                                  int *error)
{
  if (thrift_transport_write (protocol->transport,
...
int32_t
thrift_binary_protocol_read_uuid (ThriftProtocol *protocol, uuid_t *value,
                                 int *error)
{
  int32_t ret;
...
thrift_binary_protocol_init (ThriftBinaryProtocol *protocol)
{
  ...
  protocol->write_uuid = thrift_binary_protocol_write_uuid;
  ...
  protocol->read_uuid = thrift_binary_protocol_read_uuid;
}
