...
"<ewm_y type=\"struct\" identifier=\"10\" stats=\"y:DSEWM:0.2\"><EWMResult><samples type=\"u64\" identifier=\"3\">1</samples><mean type=\"double\" identifier=\"6\">0.2</mean><stddev type=\"double\" identifier=\"7\">0.4</stddev><sigma type=\"double\" identifier=\"8\">2</sigma></EWMResult></ewm_y>");
 ...
 "<ewmd_y type=\"struct\" identifier=\"13\" stats=\"y:DSEWM:0.2\"><EWMResult><samples type=\"u64\" identifier=\"3\">1</samples><mean type=\"double\" identifier=\"6\">0.1</mean><stddev type=\"double\" identifier=\"7\">0.3</stddev><sigma type=\"double\" identifier=\"8\">3</sigma></EWMResult></ewmd_y>");
                break;
            }
            case 3:
            {
...
"<ewm_y type=\"struct\" identifier=\"10\" stats=\"y:DSEWM:0.2\"><EWMResult><samples type=\"u64\" identifier=\"3\">1</samples><mean type=\"double\" identifier=\"6\">2.2</mean><stddev type=\"double\" identifier=\"7\">4.4</stddev><sigma type=\"double\" identifier=\"8\">2</sigma></EWMResult></ewm_y>");
                EXPECT_STREQ(mm["ewmd_y"].c_str(),
"<ewmd_y type=\"struct\" identifier=\"13\" stats=\"y:DSEWM:0.2\"><EWMResult><samples type=\"u64\" identifier=\"3\">1</samples><mean type=\"double\" identifier=\"6\">1.1</mean><stddev type=\"double\" identifier=\"7\">3.3</stddev><sigma type=\"double\" identifier=\"8\">3</sigma></EWMResult></ewmd_y>");
                break;
            }
            case 4:
            {
...
TEST_F(SandeshUVEAlarmTest, UVEAlarm) {
    ...
    dselem.insert(make_pair(string("ewmd_y"), string("0.1")));
