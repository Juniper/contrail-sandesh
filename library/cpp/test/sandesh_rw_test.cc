...
protected:
    ...
    void SandeshReadWriteProcess(boost::shared_ptr<TMemoryBuffer> btrans,
        ...
        for (uint32_t i = 0; i < test_list_size; i++) {
            boost::uuids::uuid uuid_temp = {0x00+i,0x00+i,0x01+i,0x01+i,0x02+i,0x02+i,0x03+i,0x03+i,0x04+i,0x04+i,0x05+i,0x05+i,0x06+i,0x06+i,0x07+i,0x07+i}; 
        ...
        EXPECT_EQ(true, wstruct_test_.get_uuidDefaultTest() == boost::uuids::string_generator()("00010203-0405-0607-0423-023434265323"));
        // Get the buffer
