...
public:
    ...
    static void DisableSendingSystemAndObjectLogs(bool disable);
    static bool IsSendingSystemAndObjectLogsDisabled();
...
private:
    ...
    static bool disable_sending_system_and_object_logs_;
